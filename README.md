...
**Hello World** is a RoR API application that generates greetings messages that are fetched in the [hello-react-front-end](https://github.com/muneeb3123/hello-react-front-end.git) front-end application.
...
```sh
  cd my-folder
  git clone https://github.com/muneeb3123/hello-rails-back-end.git
```
